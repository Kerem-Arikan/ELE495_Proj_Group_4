...
PATH_TO_LABELS =os.path.join(CWD_PATH,MODEL_NAME,LABELMAP_NAME) #"/home/pi/ELE495_Proj_Group_4/frozen_graph/labelmap.txt"
...
if use_TPU:
    interpreter = Interpreter(model_path=PATH_TO_CKPT,
                              experimental_dgates=[load_delegate('libedgetpu.so.1.0')])
    print(PATH_TO_CKPT)
else:
    interpreter = Interpreter(model_path=PATH_TO_CKPT)
